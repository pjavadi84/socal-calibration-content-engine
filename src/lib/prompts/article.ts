...
4. READABILITY (Yoast Flesch/sentence analysis — these are STRICT requirements, not suggestions):
   ...
   - TRANSITION WORDS (CRITICAL): At least 30% of ALL sentences MUST begin with or contain a transition word/phrase. Use these liberally: "however", "therefore", "in addition", "as a result", "for example", "moreover", "consequently", "furthermore", "in fact", "on the other hand", "specifically", "most importantly", "meanwhile", "similarly", "additionally", "notably", "in particular". Count your sentences — if you write 30 sentences, at least 10 must contain transitions.
   - CONSECUTIVE SENTENCES (CRITICAL): NEVER start 3 or more consecutive sentences with the same word. Vary your sentence openers deliberately. If two sentences start with "The", the next MUST start with a different word (a transition, a noun, a verb, etc.).
